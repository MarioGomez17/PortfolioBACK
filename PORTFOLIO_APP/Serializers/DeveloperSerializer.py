...
class DeveloperSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['Id_Developer', 'Name_Developer', 'LastName_Developer', 'Email_Developer', 'Phone_Developer', 'LinkedinName_Developer', 'LinkedinUrl_Developer', 'GitHubName_Developer', 'GitHubUrl_Developer', 'City_Developer', 'Description_Developer', 'ProgrammingLanguages_Developer', 'Technologies_Developer', 'Languages_Developer', 'Education_Developer', 'Skills_Developer']
