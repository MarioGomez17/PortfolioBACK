...
urlpatterns = [
    ...
    path('Portfolio/', include('PORTFOLIO_APP.Urls.AchievementUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.CityUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.CompanyUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.ContactInformationUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.ControlVersionUrls')),
    ...
    path('Portfolio/', include('PORTFOLIO_APP.Urls.DevelopmentAreaUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.EducationAchievementUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.EducationPlaceUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.EducationTypeUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.EducationUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.ExperienceUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.IdeAndToolUrls')),
    ...
    path('Portfolio/', include('PORTFOLIO_APP.Urls.ResponsabilityUrls')),
    path('Portfolio/', include('PORTFOLIO_APP.Urls.RoleUrls')),
